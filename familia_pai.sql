...
CREATE TABLE `pai` (
  `pa` int NOT NULL AUTO_INCREMENT,
  ...
  `profisão` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`pa`)
...
INSERT INTO `pai` VALUES (1,'pai ','2000-09-29',91,2,'piaui','S','prefeitura'),(2,'irmão','2000-08-28',80,2,'são paulo','C','Engenheiro-civil'),(3,'irmã','2000-07-27',70,1,'Batalha','S','contadora'),(4,'mãe','2000-06-26',60,1,'Serra','C','diretora');
...
-- Dump completed on 2026-01-16 18:25:32
